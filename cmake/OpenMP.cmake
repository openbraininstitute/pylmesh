...
if(APPLE AND CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    ...
    # Store paths for target-level usage in lmesh (avoid polluting global scope)
    set(PYLMESH_OMP_INCLUDE_DIR "${OpenMP_ROOT}/include" CACHE INTERNAL "")
    set(PYLMESH_OMP_LIBRARY "${OPENMP_RUNTIME_LIBRARY}" CACHE INTERNAL "")
    set(PYLMESH_OMP_COMPILE_OPTIONS "-Xpreprocessor;-fopenmp" CACHE INTERNAL "")
    ...
    if(OpenMP_CXX_FOUND)
        ...
        if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
            ...
            if(COMPILER_SUPPORTS_FOPENMP)
                set(PYLMESH_OMP_COMPILE_OPTIONS "-fopenmp" CACHE INTERNAL "")
                set(PYLMESH_OMP_LIBRARY "-fopenmp" CACHE INTERNAL "")
                set(PYLMESH_OMP_INCLUDE_DIR "" CACHE INTERNAL "")
